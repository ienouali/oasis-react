...
type TBookingDataBox = {
  booking: IBooking & {
    cabinPrice?: number;
    extrasPrice?: number;
    hasBreakfast?: boolean;
    observations?: string;
    guests: { fullName?:string; guestName?: string; email?: string; country?: string; countryFlag?: string; nationalID?: number }
  }
}
function BookingDataBox({ booking }: TBookingDataBox) {
  const {
    created_at,
    startDate,
    endDate,
  ...
  return (
    <StyledBookingDataBox>
      ...
      <Section>
        ...
        <Price as={'div'} isPaid={(isPaid as boolean)}>
