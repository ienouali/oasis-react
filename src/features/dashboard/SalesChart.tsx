...
import {IBookingWithExtrasPrice} from "../../services/types.ts";
...
function SalesChart({ bookings, numDays }: {
  bookings:  IBookingWithExtrasPrice[]; numDays: number}) {
      ...
      allDates
          .map(date => {
              return {
                ...
                totalSales: (bookings as  IBookingWithExtrasPrice[])
                    .filter( (bk) => isSameDay(date,  new Date(bk.created_at)))
              }
            })
